...
let DetectionDistance = require('./DetectionDistance.js');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class DetectionDistanceArray {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.detections.forEach((val) => {
      bufferOffset = DetectionDistance.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DetectionDistanceArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.detections[i] = DetectionDistance.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 8 * object.detections.length;
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DetectionDistanceArray(null);
    ...
    if (msg.detections !== undefined) {
      ...
      for (let i = 0; i < resolved.detections.length; ++i) {
        resolved.detections[i] = DetectionDistance.Resolve(msg.detections[i]);
      }
    }
    else {
      resolved.detections = []
...
module.exports = DetectionDistanceArray;
